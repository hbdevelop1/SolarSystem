...
GLfloat	AngleEarthAroundSun;
GLfloat	AngleEarthAroundEarth,AngleMoonAroundEarth;				// Angle For The Triangle ( NEW )
					...
					int			nCmdShow)			// Window Show State
{
	...
	if (!CreateGLWindow("Solar system",640,480,16))
	{
	...
	while(!g_done)									// Loop That Runs While done=FALSE
	{
		...
		else										// If There Are No Messages
		{
			...
			if (active && !RunFrame())
			{
				g_done=TRUE;							// ESC or DrawGLScene Signalled A Quit
			}
