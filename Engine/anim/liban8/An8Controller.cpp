...
/*
//hbf-my copy constructor, in order to copy only the info that are really useful (no 'Name' member)
An8Controller::An8Controller(const An8Controller &s) : Track(s.Track),HasTrack(s.HasTrack)
{
}
*/
An8Controller::~An8Controller(void)
